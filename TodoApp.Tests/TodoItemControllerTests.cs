...
public class TodoItemControllerTests
{
    ...
    public async Task Index_ReturnsViewResult_WithListOfTodoItems_ForCurrentUser()
    {
        ...
        // Note: With EntityFrameworkCore.Testing.Moq, SaveChangesAsync() is often not needed
        // for query operations as the data is directly available in the mocked DbSet.
        // However, if your controller relies on IDs generated by the DB upon Add, you might need to
        // mock SaveChangesAsync or ensure IDs are pre-set. For queries, this is fine.
    ...
    {
        // Arrange
        // Assuming your Create action takes a TodoItem directly.
        // If it takes a ViewModel (e.g., TodoItemCreateViewModel), use that here.
        var todoItemToCreate = new TodoItem
        {
            // Id will be generated by the database or not set by the user initially.
            // UserId and CreatedAt will be set by the controller.
        ...
        // Note: If your controller's Create action takes a ViewModel, 
        // you should instantiate and pass that ViewModel:
        // var createViewModel = new TodoItemCreateViewModel { Title = "...", DueDate = ... };

        // Act
        // Pass the object type that your controller's Create action expects.
        ...
        // The EntityFrameworkCore.Testing.Moq library typically handles the "Add" operation
        // by placing the item into its in-memory representation of the DbSet.
        // SaveChangesAsync might need to be "called" for the item to be queryable if the library
        // doesn't make it immediately queryable after Add. Let's assume it does for now.
        // If not, you might need to mock _mockedDbContext.SaveChangesAsync() if your controller calls it.
    ...
    {
        // Arrange
        var newTodoItemVM = new TodoItem(); // Or TodoItem if that's what Create takes
        ...
        // Assert
        var viewResult = Assert.IsType<ViewResult>(result);
        Assert.Equal(newTodoItemVM, viewResult.Model); // Or check the type if model is different
    }
